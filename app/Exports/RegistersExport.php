    ...
    public function view(): View
    {
        return view('principal/excel', [
            'datosPerson' => DB::table('person')
                ...
                ->select('person.id','person.full_name', 'campuses.official_name', 'person.job_email', 'person.personal_email', 'registers.check_in', 'registers.check_out', 'registers.is_loading', 'registers.is_food', 'registers.food_description', 'registers.notes')
